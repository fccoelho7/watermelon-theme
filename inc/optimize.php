 ...
 */
function theme_modify_category_rel( $text ) {
...
add_filter( 'wp_list_categories', 'theme_modify_category_rel' );
add_filter( 'the_category', 'theme_modify_category_rel' );

/**
 * Add rel="nofollow" and remove rel="tag".
 */
function theme_modify_tag_rel( $taglink ) {
	return str_replace( 'rel="tag">', 'rel="nofollow">', $taglink );
}

add_filter( 'wp_tag_cloud', 'theme_modify_tag_rel' );
add_filter( 'the_tags', 'theme_modify_tag_rel' );
